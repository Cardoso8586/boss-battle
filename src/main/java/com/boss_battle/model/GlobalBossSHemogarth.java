...
@Entity
@Table(name = "global_boss_s_hemogarth")
public class GlobalBossSHemogarth implements BattleBoss {
    ...
    private String name = "S-HEMOGARTH";
    ...
    private String imageUrl = "images/boss_s_hemogarth.webp";
