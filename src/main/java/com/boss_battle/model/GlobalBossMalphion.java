...
@Entity
@Table(name = "global_boss_malphion_prime")
public class GlobalBossMalphion implements BattleBoss {
    ...
    private String name = "MALPHION";

    @Column(nullable = false)
    private long maxHp = 380_000L;

    @Column(nullable = false)
    private long currentHp = 380_000L;
    ...
    private long respawnCooldownSeconds = 15_000L;

    private int spawnCount = 0;
    
   @Column(nullable = true)
   private String imageUrl = "images/boss_evolution/boss_malphion/boss_malphion.webp";
    
  //  @Column(nullable = true)
    //private String imageUrl = "images/boss_malphion_prime.webp";
