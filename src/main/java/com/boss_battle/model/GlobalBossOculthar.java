...
@Entity
@Table(name = "global_boss_oculthar")
public class GlobalBossOculthar implements BattleBoss {
    ...
    private String imageUrl = "images/boss_oculthar.webp";
