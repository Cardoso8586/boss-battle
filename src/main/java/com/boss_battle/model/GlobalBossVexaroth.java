...
@Entity
@Table(name = "global_boss_vexaroth")
public class GlobalBossVexaroth implements BattleBoss {
    ...
    private String imageUrl = "images/boss_vexaroth.webp";
