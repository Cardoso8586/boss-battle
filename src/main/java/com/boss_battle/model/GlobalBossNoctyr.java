...
@Entity
@Table(name = "global_boss_noctyr")
public class GlobalBossNoctyr implements BattleBoss {
    ...
    private long respawnCooldownSeconds = 5400L; // 90 minutos

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_noctyr.webp";

    @Column(nullable = false)
    private long rewardBoss = 55_000L;
    ...
    public void aplicarEscalamentoNoctyr() {
