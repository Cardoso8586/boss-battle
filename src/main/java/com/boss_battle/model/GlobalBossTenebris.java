...
@Entity
@Table(name = "global_boss_tenebris")
public class GlobalBossTenebris implements BattleBoss {
    ...
    private long respawnCooldownSeconds = 6600L; // 1h50min
    ...
    public void aplicarEscalamentoTenebris() {
