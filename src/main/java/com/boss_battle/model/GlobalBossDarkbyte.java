...
@Entity
@Table(name = "global_boss_darkbyte")
public class GlobalBossDarkbyte implements BattleBoss {
    ...
    private String imageUrl = "images/boss_darkbyte.webp";
