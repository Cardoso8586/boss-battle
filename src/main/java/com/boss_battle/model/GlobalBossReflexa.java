...
@Entity
@Table(name = "global_boss_reflexa")
public class GlobalBossReflexa implements BattleBoss {
    ...
    private long respawnCooldownSeconds = 4800L; // 1h20

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_reflexa.webp";
