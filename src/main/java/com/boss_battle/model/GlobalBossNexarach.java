...
@Entity
@Table(name = "global_boss_nexarach")
public class GlobalBossNexarach implements BattleBoss {
    ...
    private String imageUrl = "images/boss_nexarach.webp";
