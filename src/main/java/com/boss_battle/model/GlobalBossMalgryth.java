...
@Entity
@Table(name = "global_boss_malgryth")
public class GlobalBossMalgryth implements BattleBoss {
    ...
    private String imageUrl = "images/boss_malgryth.webp";

    @Column(nullable = false)
    private long rewardBoss = 250_000L;

    @Column(nullable = false)
    private long rewardExp = 40_000L;
