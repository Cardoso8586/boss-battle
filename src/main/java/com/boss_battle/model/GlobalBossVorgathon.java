...
@Entity
@Table(name = "global_boss_vorgathon")
public class GlobalBossVorgathon implements BattleBoss {
    ...
    private String imageUrl = "images/boss_vorgathon.webp";
