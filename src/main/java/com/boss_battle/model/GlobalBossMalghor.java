...
@Entity
@Table(name = "global_boss_malghor")
public class GlobalBossMalghor implements BattleBoss {
    ...
    // ☠️ ataque demoníaco brutal
    private long attackPower = 160L;

    // ataque extremamente agressivo
    ...
    // respawn em 10 horas
    private long respawnCooldownSeconds = 36_000L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_malghor.webp";
    ...
    @Column(nullable = false)
    private long rewardExp = 35_000L;
