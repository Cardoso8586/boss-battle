...
@Entity
@Table(name = "global_boss_oblivion")
public class GlobalBossOblivion implements BattleBoss {
    ...
    private long respawnCooldownSeconds = 7200L; // 2 horas
