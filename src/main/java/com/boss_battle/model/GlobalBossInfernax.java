...
@Entity
@Table(name = "global_boss_infernax")
public class GlobalBossInfernax implements BattleBoss {
    ...
    private long respawnCooldownSeconds = 7200L; // 2h
    ...
    public void aplicarEscalamentoInfernax() {
