...
@Entity
@Table(name = "global_boss_pyragon")
public class GlobalBossPyragon implements BattleBoss {
    ...
    private long attackPower = 320L; // mais agressivo

    private long attackIntervalSeconds = 30L; // muito rápido
    ...
    private long respawnCooldownSeconds = 3600L; // respawn rápido (1h)
    ...
    public void aplicarEscalamentoPyragon() {
    	...
    	setRewardExp(valorXp + 7);
    	
    	long valorsetRewardBoss = getRewardBoss();
 	    setRewardBoss(valorsetRewardBoss + 4);
