...
@Entity
@Table(name = "global_boss_flamor")
public class GlobalBossFlamor implements BattleBoss {
    ...
    private long respawnCooldownSeconds = 3600L; // respawn mais rápido
  ...
  //===========================================================
    ...
    public void aplicarEscalamentoFlamor() {
    ...
    }//--->incrmentar hp, toda vez que o boss for destruido
}
