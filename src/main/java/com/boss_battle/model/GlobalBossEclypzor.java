...
@Entity
@Table(name = "global_boss_eclypzor")
public class GlobalBossEclypzor implements BattleBoss {
    ...
    private String imageUrl = "images/boss_eclypzor.webp";

    @Column(nullable = false)
    private long rewardBoss = 110_000L;

    @Column(nullable = false)
    private long rewardExp = 20_000L;
