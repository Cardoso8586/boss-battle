...
@Entity
@Table(name = "global_boss_zerathon")
public class GlobalBossZerathon implements BattleBoss {
    ...
    private long attackPower = 170L;

    private long attackIntervalSeconds = 245L;
    ...
    private String imageUrl = "images/boss_zerathon.webp";
