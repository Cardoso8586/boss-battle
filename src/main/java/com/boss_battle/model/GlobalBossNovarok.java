...
@Entity
@Table(name = "global_boss_novarok")
public class GlobalBossNovarok implements BattleBoss {
    ...
    // respawn em 12 horas
    private long respawnCooldownSeconds = 43_200L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_novarok.webp";
    ...
    @Column(nullable = false)
    private long rewardExp = 50_000L;
