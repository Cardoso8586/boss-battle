...
@Entity
@Table(name = "global_boss_glaciara")
public class GlobalBossGlaciara implements BattleBoss {
    ...
    private long respawnCooldownSeconds = 6000L; // 1h40min
    ...
    public void aplicarEscalamentoGlaciara() {
