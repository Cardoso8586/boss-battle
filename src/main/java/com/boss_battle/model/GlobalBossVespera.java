...
@Entity
@Table(name = "global_boss_vespera")
public class GlobalBossVespera implements BattleBoss {
    ...
    private long respawnCooldownSeconds = 3600L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_vespera.webp";

    @Column(nullable = false)
    private long rewardBoss = 45_000L;

    @Column(nullable = false)
    private long rewardExp = 1900;
    ...
    public void aplicarEscalamentoVespera() {
