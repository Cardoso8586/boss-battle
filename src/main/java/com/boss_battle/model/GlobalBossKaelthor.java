...
@Entity
@Table(name = "global_boss_kaelthor")
public class GlobalBossKaelthor implements BattleBoss {
    ...
    // respawn 2 horas
    private long respawnCooldownSeconds = 7_200L;
