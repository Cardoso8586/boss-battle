...
@Entity
@Table(name = "global_boss_vorlath")
public class GlobalBossVorlath implements BattleBoss {
    ...
    private String imageUrl = "images/boss_vorlath.webp";
