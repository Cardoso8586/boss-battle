...
@Entity
@Table(name = "global_boss_mechadron")
public class GlobalBossMechadron implements BattleBoss {
    ...
    private String imageUrl = "images/boss_mechadron.webp";
    ...
    public void aplicarEscalamentoMechadron() {
