...
@Entity
@Table(name = "global_boss_tharzul")
public class GlobalBossTharzul implements BattleBoss {
    ...
    private String imageUrl = "images/boss_tharzul.webp";
