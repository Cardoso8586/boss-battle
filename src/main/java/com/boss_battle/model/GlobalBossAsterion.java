...
@Entity
@Table(name = "global_boss_asterion")
public class GlobalBossAsterion implements BattleBoss {
    ...
    private String name = "ASTERION";

    @Column(nullable = false)
    private long maxHp = 120_000L;

    @Column(nullable = false)
    private long currentHp = 120_000L;

    // 🌌 ataque celestial destrutivo
    ...
    // respawn em 14 horas
    private long respawnCooldownSeconds = 50_400L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_asterion.webp";
    ...
    @Column(nullable = false)
    private long rewardExp = 80_000L;
