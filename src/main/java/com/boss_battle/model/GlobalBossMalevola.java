...
@Entity
@Table(name = "global_boss_malevola")
public class GlobalBossMalevola implements BattleBoss {
    ...
    private String name = "MALEVOLA, SENHORA DAS TREVAS";

    @Column(nullable = false)
    private long maxHp = 110_000L;

    @Column(nullable = false)
    private long currentHp = 110_000L;

    private long attackPower = 70L;

    // ataca rápido, mas com um pouco mais de peso
    ...
    private long respawnCooldownSeconds = 9_000L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_malevola.webp";

    @Column(nullable = false)
    private long rewardBoss = 130_000L;

    @Column(nullable = false)
    private long rewardExp = 24_000L;
