...
@Entity
@Table(name = "global_boss_hyperion_x")
public class GlobalBossHyperionX implements BattleBoss {
    ...
    private String name = "HYPERION-X";
    ...
    private String imageUrl = "images/boss_hyperion_x.webp";

    @Column(nullable = false)
    private long rewardBoss = 130_000L;

    @Column(nullable = false)
    private long rewardExp = 90_000L;
