...
@Entity
@Table(name = "global_boss_morvyra")
public class GlobalBossMorvyra implements BattleBoss {
    ...
    // respawn em 24 horas
    private long respawnCooldownSeconds = 86_400L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_morvyra.webp";
