...
@Entity
@Table(name = "global_boss_nightmare")
public class GlobalBossNightmare implements BattleBoss {
    ...
    private long attackIntervalSeconds = 40L; // mais rápido
    ...
    private long respawnCooldownSeconds = 10800L; // respawn mais demorado (3h)

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_nightmare.webp";
    ...
    public void aplicarEscalamentoNightmare() {
    	...
    	long valorsetRewardBoss = getRewardBoss();
 	    setRewardBoss(valorsetRewardBoss + 5);
