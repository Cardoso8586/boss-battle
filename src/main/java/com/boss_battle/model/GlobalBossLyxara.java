...
@Entity
@Table(name = "global_boss_lyxara")
public class GlobalBossLyxara implements BattleBoss {
    ...
    private String name = "LYXARA"; // boss feminina, nome forte

    @Column(nullable = false)
    private long maxHp = 40_000L;
    ...
    private long respawnCooldownSeconds = 4800L; // 80 min
    ...
    public void aplicarEscalamentoLyxara() {
