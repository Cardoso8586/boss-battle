...
@Entity
@Table(name = "global_boss_xaphiron")
public class GlobalBossXaphiron implements BattleBoss {
    ...
    private String imageUrl = "images/boss_xaphiron.webp";

    @Column(nullable = false)
    private long rewardBoss = 100_000L;

    @Column(nullable = false)
    private long rewardExp = 120_000L;
