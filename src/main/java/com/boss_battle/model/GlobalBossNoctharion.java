...
@Entity
@Table(name = "global_boss_noctharion")
public class GlobalBossNoctharion implements BattleBoss {
    ...
    private long attackIntervalSeconds = 30L;
    ...
    private long respawnCooldownSeconds = 5400L;
