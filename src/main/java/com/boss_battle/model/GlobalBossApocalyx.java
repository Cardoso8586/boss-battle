...
@Entity
@Table(name = "global_boss_apocalyx")
public class GlobalBossApocalyx implements BattleBoss {
    ...
    private String imageUrl = "images/boss_apocalyx.webp";

    @Column(nullable = false)
    private long rewardBoss = 130_000L;

    @Column(nullable = false)
    private long rewardExp = 130_000L;
