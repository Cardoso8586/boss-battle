...
@Entity
@Table(name = "global_boss_titanex")
public class GlobalBossTitanex implements BattleBoss {
    ...
    private String imageUrl = "images/boss_titanex.webp";

    @Column(nullable = false)
    private long rewardBoss = 110_000L;

    @Column(nullable = false)
    private long rewardExp = 60_000L;
