...
@Entity
@Table(name = "global_boss_vorgrim")
public class GlobalBossVorgrim implements BattleBoss {
    ...
    private String name = "VORGRIM";

    @Column(nullable = false)
    private long maxHp = 250_000L;
    ...
    private long attackIntervalSeconds = 70L;
    ...
    private String imageUrl = "images/boss_vorgrim.webp";
