...
@Entity
@Table(name = "global_boss_vesta")
public class GlobalBossVesta implements BattleBoss {
    ...
    private long attackPower = 65L;

    // ataca relativamente rápido
    ...
    private String imageUrl = "images/boss_vesta.webp";
