...
@Entity
@Table(name = "global_boss_cybraxus")
public class GlobalBossCybraxus implements BattleBoss {
    ...
    // ⚡ ataque brutal cibernético
    private long attackPower = 120L;

    // ataca a cada 2 minutos
    ...
    // respawn em 6 horas
    private long respawnCooldownSeconds = 21_600L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_cybraxus.webp";
