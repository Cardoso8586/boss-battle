...
@Entity
@Table(name = "global_boss_oblivar")
public class GlobalBossOblivar implements BattleBoss {
    ...
    private String name = "OBLIVAR"; // nome forte e chamativo

    @Column(nullable = false)
    private long maxHp = 35_000L;
    ...
    private long respawnCooldownSeconds = 4200L; // 70 min
    ...
    public void aplicarEscalamentoOblivar() {
