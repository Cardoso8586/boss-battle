...
@Entity
@Table(name = "global_boss_voidreaper")
public class GlobalBossVoidreaper implements BattleBoss {
    ...
    private String name = "VOIDREAPER";
    ...
    private String imageUrl = "images/boss_voidreaper.webp";

    @Column(nullable = false)
    private long rewardBoss = 130_000L;

    @Column(nullable = false)
    private long rewardExp = 110_000L;
