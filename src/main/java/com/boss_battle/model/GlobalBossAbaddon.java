...
@Entity
@Table(name = "global_boss_abaddon")
public class GlobalBossAbaddon implements BattleBoss {
    ...
    private String name = "ABADDON";

    @Column(nullable = false)
    private long maxHp = 60_000L;       // <-- ajuste aqui

    @Column(nullable = false)
    private long currentHp = 60_000L;  // <-- ajuste aqui

    private long attackPower = 50L;    // <-- ajuste aqui

    private long attackIntervalSeconds = 100L; // <-- ajuste aqui
    ...
    private long respawnCooldownSeconds = 21_600L; // <-- ajuste aqui

    private int spawnCount = 0;
    
    @Column(nullable = true)
    private String imageUrl =
        "images/boss_abaddon.webp"; // <-- ajuste aqui

    @Column(nullable = false)
    private long rewardBoss = 100_000L;  // <-- ajuste aqui

    @Column(nullable = false)
    private long rewardExp = 22_000L;   // <-- ajuste aqui
