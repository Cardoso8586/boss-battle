...
@Entity
@Table(name = "global_boss_kronvex")
public class GlobalBossKronvex implements BattleBoss {
    ...
    // respawn em 18 horas
    private long respawnCooldownSeconds = 64_800L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_kronvex.webp";
    ...
    @Column(nullable = false)
    private long rewardExp = 30_000L;
