...
@Entity
@Table(name = "global_boss_drakzhor")
public class GlobalBossDrakzhor implements BattleBoss {
    ...
    private String imageUrl = "images/boss_drakzhor.webp";
