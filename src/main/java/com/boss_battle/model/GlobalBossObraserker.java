...
@Entity
@Table(name = "global_boss_obraserker")
public class GlobalBossObraserker implements BattleBoss {
    ...
    private String name = "OBRASERKER, GIGANTE DE AÇO";
    ...
    private String imageUrl = "images/boss_obraserker.webp";
