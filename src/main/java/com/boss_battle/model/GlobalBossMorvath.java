...
@Entity
@Table(name = "global_boss_morvath")
public class GlobalBossMorvath implements BattleBoss {
    ...
    private String name = "MORVATH"; // nome sombrio, intimidador
    ...
    public void aplicarEscalamentoMorvat() {
