...
@Entity
@Table(name = "global_boss_v_zurvio")
public class GlobalBossVZurvio implements BattleBoss {
    ...
    private String imageUrl = "images/boss_v_zurvio.webp";
