...
@Entity
@Table(name = "global_boss_nexaron")
public class GlobalBossNexaron implements BattleBoss {
    ...
    private String imageUrl = "images/boss_nexaron.webp";
