...
@Entity
@Table(name = "global_boss_gatalicos")
public class GlobalBossGatalicos implements BattleBoss {
    ...
    private String imageUrl = "images/boss_gatalicos.webp";
