...
@Entity
@Table(name = "global_boss_puppetrix")
public class GlobalBossPuppetrix implements BattleBoss {
    ...
    private String imageUrl = "images/boss_puppetrix.webp";
