...
@Entity
@Table(name = "global_boss_xarvokth")
public class GlobalBossXarvokth implements BattleBoss {
    ...
    private String imageUrl = "images/boss_xarvokth.webp";

    @Column(nullable = false)
    private long rewardBoss = 200_000L;
