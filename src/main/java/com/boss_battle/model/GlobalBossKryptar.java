...
@Entity
@Table(name = "global_boss_kryptar")
public class GlobalBossKryptar implements BattleBoss {
    ...
    // respawn em 20 horas
    private long respawnCooldownSeconds = 72_000L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_kryptar.webp";
