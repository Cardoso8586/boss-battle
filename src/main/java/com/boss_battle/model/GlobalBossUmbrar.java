...
@Entity
@Table(name = "global_boss_umbrar")
public class GlobalBossUmbrar implements BattleBoss {
    ...
    private String name = "UMBRAR"; // nome sombrio e original

    @Column(nullable = false)
    private long maxHp = 42_000L;
    ...
    private long respawnCooldownSeconds = 4500L; // 75 minutos
  ...
  //===========================================================
    ...
    public void aplicarEscalamentoUmbrar() {
