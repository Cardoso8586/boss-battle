...
@Entity
@Table(name = "global_boss_tharvok")
public class GlobalBossTharvok implements BattleBoss {
    ...
    private String imageUrl = "images/boss_tharvok.webp";
