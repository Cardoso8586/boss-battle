...
@Entity
@Table(name = "global_boss_exodrax")
public class GlobalBossExodrax implements BattleBoss {
    ...
    private String imageUrl = "images/boss_exodrax.webp";
