...
@Entity
@Table(name = "global_boss_nyxara")
public class GlobalBossNyxara implements BattleBoss {
    ...
    // respawn em 22 horas
    private long respawnCooldownSeconds = 79_200L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_nyxara.webp";
    ...
    @Column(nullable = false)
    private long rewardExp = 100_000L;
