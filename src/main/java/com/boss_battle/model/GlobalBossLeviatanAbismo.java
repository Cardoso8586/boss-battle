...
@Entity
@Table(name = "global_boss_leviatan_abismo")
public class GlobalBossLeviatanAbismo implements BattleBoss {
    ...
    private String name = "LEVIATÃ DO ABISMO";
    ...
    private String imageUrl = "images/boss_leviatan_abismo.webp";

    @Column(nullable = false)
    private long rewardBoss = 100_000L;

    @Column(nullable = false)
    private long rewardExp = 25_000L;
    ...
    public GlobalBossLeviatanAbismo() {}
    ...
    public void setAttackIntervalSeconds(long value) { this.attackIntervalSeconds = value; }
    ...
    public void setRespawnCooldownSeconds(long value) { this.respawnCooldownSeconds = value; }

    public long getSpawnCount() { return spawnCount; }
    @Override
    public void setSpawnCount(long value) { this.spawnCount = Math.toIntExact(value); }
    ...
    public void setProcessingDeath(boolean processingDeath) { this.processingDeath = processingDeath; }

    public boolean isRewardDistributed() { return rewardDistributed; }
    public void setRewardDistributed(boolean rewardDistributed) { this.rewardDistributed = rewardDistributed; }
    ...
    public Map<String, Long> applyDamage(long damage) {
        ...
        if (finalHp == 0) {
            alive = false;
            respawnAt = LocalDateTime.now().plusSeconds(respawnCooldownSeconds);
