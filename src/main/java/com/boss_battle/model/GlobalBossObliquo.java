...
@Entity
@Table(name = "global_boss_obliquo")
public class GlobalBossObliquo implements BattleBoss {
    ...
    private String name = "OBLÍQUO";

    @Column(nullable = false)
    private long maxHp = 48_000L;
    ...
    private long respawnCooldownSeconds = 4800L; // 80 minutos

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_obliquo.webp";

    @Column(nullable = false)
    private long rewardBoss = 45_000L;

    @Column(nullable = false)
    private long rewardExp = 2000;
    ...
    public void aplicarEscalamentoObliquo() {
