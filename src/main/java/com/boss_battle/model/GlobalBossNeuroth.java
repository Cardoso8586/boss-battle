...
@Entity
@Table(name = "global_boss_neuroth")
public class GlobalBossNeuroth implements BattleBoss {
    ...
    private String name = "NEUROTH";

    @Column(nullable = false)
    private long maxHp = 85_000L;

    @Column(nullable = false)
    private long currentHp = 85_000L;

    // 🧠 ataque neural sombrio
    ...
    // respawn em 8 horas
    private long respawnCooldownSeconds = 28_800L;

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_neuroth.webp";
    ...
    @Column(nullable = false)
    private long rewardExp = 22_000L;
