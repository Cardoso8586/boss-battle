...
@Entity
@Table(name = "global_boss_cryophantasm")
public class GlobalBossCryophantasm implements BattleBoss {
    ...
    private String name = "CRYOPHANTASM, SENHOR DO GELADO TERROR";
    ...
    private long attackPower = 76L;  // forte, mas um pouco mais lento
    ...
    private long respawnCooldownSeconds = 7_200L;  // 2 horas

    private int spawnCount = 0;

    @Column(nullable = true)
    private String imageUrl = "images/boss_cryophantasm.webp";
