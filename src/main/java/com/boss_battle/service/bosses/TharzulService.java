...
import com.boss_battle.repository.TharzulRepository;
...
public class TharzulService {
    ...
    @Autowired
    private TharzulRepository repo;

    public GlobalBossTharzul get() {
        return repo.findById(1L).orElseGet(() -> createDefaultBoss());
    }

    public GlobalBossTharzul createDefaultBoss() {

        GlobalBossTharzul boss = new GlobalBossTharzul();

        boss.setName("THARZUL");
        boss.setProcessingDeath(false);
        boss.setAlive(true);
        boss.setImageUrl("images/boss_tharzul.webp");
    ...
    public GlobalBossTharzul save(GlobalBossTharzul boss) {
        return repo.save(boss);
    }

    public GlobalBossTharzul attack(long damage) {
    ...
    //===========================================================
    public void aplicarEscalamentoTharzul(GlobalBossTharzul boss) {
