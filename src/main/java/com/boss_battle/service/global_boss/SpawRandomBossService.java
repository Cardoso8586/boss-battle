	      ...
	      KillAllBossesService.killAllBosses();
	        ...
	        switch (choice) {
	            ...
	            case 34 -> {
	            	...
	            	nexah.setAlive(true);
	            	nexah.setCurrentHp(nexah.getMaxHp());
	            	nexah.setSpawnedAt(LocalDateTime.now());
	            ...
	            case 35 -> {
	            	...
	            	cyberionService.aplicarEscalamentoCyberion(cyber);
	            	cyber.setProcessingDeath(false);
	            	cyber.setAlive(true);
	            	cyber.setCurrentHp(cyber.getMaxHp());
	            	cyber.setSpawnedAt(LocalDateTime.now());
	            ...
	            case 36 -> {
	            	...
	            	azuragonService.aplicarEscalamentoAzuragon(azura);
	            	azura.setProcessingDeath(false);
	            	azura.setAlive(true);
	            	azura.setCurrentHp(azura.getMaxHp());
	            	azura.setSpawnedAt(LocalDateTime.now());
	            ...
	            case 37 -> {
	            	...
	            	ocultharService.aplicarEscalamentoOculthar(ocult);
	            	ocult.setProcessingDeath(false);
	            	ocult.setAlive(true);
	            	ocult.setCurrentHp(ocult.getMaxHp());
	            	ocult.setSpawnedAt(LocalDateTime.now());
               ...
               case 54 -> {
            	   ...
            	   vexaro.setCurrentHp(vexaro.getMaxHp());
            	   vexaro.setSpawnedAt(LocalDateTime.now());
               ...
               case 55 -> {
            	   ...
            	   tharz.setAlive(true);
            	   tharz.setCurrentHp(tharz.getMaxHp());
            	   tharz.setSpawnedAt(LocalDateTime.now());
               ...
               case 56 -> {
            	   ...
            	   vorgrim.setCurrentHp(vorgrim.getMaxHp());
            	   vorgrim.setSpawnedAt(LocalDateTime.now());
               ...
               case 57 -> {
            	   ...
            	   xaphi.setAlive(true);
            	   xaphi.setCurrentHp(xaphi.getMaxHp());
            	   xaphi.setSpawnedAt(LocalDateTime.now());
               ...
               case 58 -> {
            	   ...
            	   exodrax.setCurrentHp(exodrax.getMaxHp());
            	   exodrax.setSpawnedAt(LocalDateTime.now());
               ...
               case 59 -> {
            	   ...
            	   apocal.setCurrentHp(apocal.getMaxHp());
            	   apocal.setSpawnedAt(LocalDateTime.now());
               ...
               case 60 -> {
            	   ...
            	   eclypzor.setCurrentHp(eclypzor.getMaxHp());
