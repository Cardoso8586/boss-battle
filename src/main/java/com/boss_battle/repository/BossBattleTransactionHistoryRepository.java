...
public interface BossBattleTransactionHistoryRepository
        extends JpaRepository<BossBattleTransactionHistory, Long> {
    ...
    List<BossBattleTransactionHistory> findTop20ByOrderByCreatedAtDesc();
}
