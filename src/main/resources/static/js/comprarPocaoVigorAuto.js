...
document.addEventListener('DOMContentLoaded', () => {
    ...
    btnComprar.addEventListener('click', async () => {
        ...
        const textoOriginal = 'Comprar Poção';
        ...
        try {
            ...
            if (res.ok) {
                Swal.fire({
                    ...
                    title: quantidade <= 1
                        ? `Você comprou ${quantidade} poção de Vigor.`
                        : `Você comprou ${quantidade} poções de Vigor.`,
            ...
            Swal.fire({
                ...
                text: erro || 'Não foi possível comprar.',
	            ...
	            if (res.ok) {
					...
					if (quantidade<=1){
						Swal.fire({
						  ...
						  title: `Você comprou <b>${quantidade}</b> poção de <b>Vigor</b>.`,
						...
						Swal.fire({
												  ...
												  title: `Você comprou <b>${quantidade}</b> poções de <b>Vigor</b>.`,
												  html: 'Compra realizada!',
												  imageUrl: pocaoVigorOkImg,
												  imageWidth: 90,   
												  imageHeight: 120,
